...
class ReactionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ReactionViewHolder(
            this,
            LayoutInflater.from(parent.context).inflate(R.layout.voted_item, parent, false)
        )
    }
    ...
    var voitedItemClickListener: OnVoitedItemClickListener? = null

    interface OnVoitedItemClickListener {
        fun onVoitedItemClicked(item: ReactionModel, position: Int)
    }
}